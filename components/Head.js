...
export default function HeadLazslo(props){
  return (
    <div>
      <html lang={'fr'} />
      <Head>
        <title>Notaire Lazslo BONNOT - MONTFAVET / AVIGNON</title>
        ...
        <meta content="43.92968675227367, 4.87486904206106" name="geo.position" />
        ...
        <meta itemProp="name" content="'Etude Lazslo bonnot | Notaire à Montfavet (Avignon)'" />
